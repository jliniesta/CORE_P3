...
class Game {
    ...
    endGame () {
        this.ended = true;
        let gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, this.player.lives ? YOU_WIN_PICTURE : GAME_OVER_PICTURE);
        gameOver.render();
    }
    ...
    update () {
        if (!this.ended) {
            ...
            this.opponent && this.opponent.update();
    ...
    render () {
        ...
        document.getElementById("scoreli").innerHTML = `Score: ${this.score}`; //"Score: " + this.score
